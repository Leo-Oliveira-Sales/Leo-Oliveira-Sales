...
Graduando em **Ciência de Dados**, com experiência em Análise Exploratória de Dados (EDA), Pré-processamento e Engenharia de Atributos com **Python**. Possuo experiência em construção de modelos de **Machine Learning**, além de sólidos conhecimentos em **SQL** para análise de dados e conhecimentos em desenvolvimento de dashboards no **Power BI.**
